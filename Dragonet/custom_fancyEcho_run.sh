...
T0.f[${SERVERIP}:7777/10.113.4.57:8000] \
 -c 64000 -m 64000 -u root -p 0 -U  7777 -t 1 -l ${SERVERIP}
}

run_memcached_single_core_specific_two_flows() {
sudo ../benchmarking/memcached/memcached -N  \
T0.f[${SERVERIP}:7777/10.113.4.57:8000]f[${SERVERIP}:7777/10.113.4.29:8000] \
 -c 64000 -m 64000 -u root -p 0 -U  7777 -t 1 -l ${SERVERIP}
}

run_memcached_2_cores_specific() {
sudo ../benchmarking/memcached/memcached -N  \
T0.f[${SERVERIP}:7777/10.113.4.71:8000]f[${SERVERIP}:7777/10.113.4.57:8000]T1.f[${SERVERIP}:7777/10.113.4.57:8001]f[${SERVERIP}:7777/10.113.4.71:8001] \
 -c 64000 -m 64000 -u root -p 0 -U  7777 -t 2 -l ${SERVERIP}
# use following command from appenzeller to test the flows (10.113.4.71 is appenzeller 10G interface)
# ssh appenzeller 'cd dragonet/benchmarking/libmemcached-1.0.18 ; memaslap -s ${SERVERIP}:7777 --udp -x100  --cfg_cmd=./bmKey_64_val_1024.conf -T1 -c 2 -b -S10m -z 8000'
}
...
sudo ../benchmarking/memcached/memcached -N  \
T0.f[${SERVERIP}:7777/10.113.4.51:8000]T1.f[${SERVERIP}:7777/10.113.4.57:8000]T2.f[${SERVERIP}:7777/10.113.4.29:8000]T3.f[${SERVERIP}:7777/10.113.4.20:8000] \
 -c 64000 -m 64000 -u root -p 0 -U  7777 -t 4 -l ${SERVERIP}
}

run_memcached_4conc_4clients() {
sudo ../benchmarking/memcached/memcached -N  \
T0.f[${SERVERIP}:7777/10.113.4.51:8000]f[${SERVERIP}:7777/10.113.4.51:8001]f[${SERVERIP}:7777/10.113.4.51:8002]f[${SERVERIP}:7777/10.113.4.51:8003]T1.f[${SERVERIP}:7777/10.113.4.57:8000]f[${SERVERIP}:7777/10.113.4.57:8001]f[${SERVERIP}:7777/10.113.4.57:8002]f[${SERVERIP}:7777/10.113.4.57:8003]T2.f[${SERVERIP}:7777/10.113.4.29:8000]f[${SERVERIP}:7777/10.113.4.29:8001]f[${SERVERIP}:7777/10.113.4.29:8002]f[${SERVERIP}:7777/10.113.4.29:8003]T3.f[${SERVERIP}:7777/10.113.4.20:8000]f[${SERVERIP}:7777/10.113.4.20:8001]f[${SERVERIP}:7777/10.113.4.20:8002]f[${SERVERIP}:7777/10.113.4.20:8003] \
 -c 64000 -m 64000 -u root -p 0 -U  7777 -t 4 -l ${SERVERIP}
}
...
sudo ../benchmarking/memcached/memcached -N  \
T0.f[${SERVERIP}:7777/10.113.4.51:8000]f[${SERVERIP}:7777/10.113.4.51:8001]f[${SERVERIP}:7777/10.113.4.51:8002]f[${SERVERIP}:7777/10.113.4.51:8003]f[${SERVERIP}:7777/10.113.4.57:8000]f[${SERVERIP}:7777/10.113.4.57:8001]f[${SERVERIP}:7777/10.113.4.57:8002]f[${SERVERIP}:7777/10.113.4.57:8003]T1.f[${SERVERIP}:7777/10.113.4.26:8000]f[${SERVERIP}:7777/10.113.4.26:8001]f[${SERVERIP}:7777/10.113.4.26:8002]f[${SERVERIP}:7777/10.113.4.26:8003]f[${SERVERIP}:7777/10.113.4.29:8000]f[${SERVERIP}:7777/10.113.4.29:8001]f[${SERVERIP}:7777/10.113.4.29:8002]f[${SERVERIP}:7777/10.113.4.29:8003]T2.f[${SERVERIP}:7777/10.113.4.20:8000]f[${SERVERIP}:7777/10.113.4.20:8001]f[${SERVERIP}:7777/10.113.4.20:8002]f[${SERVERIP}:7777/10.113.4.20: